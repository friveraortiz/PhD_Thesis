...
public class AOPFileDatabase 
{
   ...
   public void loadProjects() throws Exception 
   {
      ...
      String plName="", dbmsName="", inputMethodName="", startMethod="", endMethod="", 
    		 connectMethod="", connectMethodReturnValue="", connectMethodType="", 
    		 operatingSystem="", remoteDir="";
   ...
   public int save(ConfigFile configFile) throws Exception
   {
      ...
      String selectSql="", insertSql="", updateSql="", errorMessage1="", errorMessage2="",
		     ...
		     connectProjMethodType="", remoteOperatingSystem="", projectOutputRemoteDir="";
	  ...
	  connectProjMethodType = configFile.getConnectProjMethodType();
	  remoteOperatingSystem       = configFile.getRemoteOperatingSystem();
	  projectOutputRemoteDir = configFile.getProjectOutputRemoteDir();
	  ...
	  if (count == 0) 
      {
         ...
         try
         {
	        ...
	        insertSql = insertSql + "pc_end_project_method, pc_connect_project_method, pc_operating_system, ";
	        insertSql = insertSql + "pc_connect_project_method_return_value, pc_connect_project_method_type, pc_project_output_remote_dir) ";
            ...
            insertStatement.setString(col++, remoteOperatingSystem);
            insertStatement.setString(col++, connectProjMethodReturnValue);
            insertStatement.setString(col++, connectProjMethodType);
            insertStatement.setString(col++, projectOutputRemoteDir);
      ...
      {	  
         ...
         try
         {
	        ...
	        updateSql = updateSql + "pc_connect_project_method_type = ?, ";
		    ...
		    updateStatement.setString(col++, remoteOperatingSystem);
		    updateStatement.setString(col++, connectProjMethodReturnValue);
		    updateStatement.setString(col++, connectProjMethodType);
		    updateStatement.setString(col++, projectOutputRemoteDir);
