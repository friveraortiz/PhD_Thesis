...
public class AttributeSequenceDiagram
{
   ...
   {
	   return "AttributeSequenceDiagram [projectIdentifier=" + projectIdentifier + ", methodIdentifier=" + methodIdentifier
			...
			+ attributeIdentifier + ", dataTypeIdentifier2=" + dataTypeIdentifier2 + ", programmingLanguageIdentifier2="
			+ programmingLanguageIdentifier2 + ", attributeName=" + attributeName + ", attributeValue=" + attributeValue
			+ ", attributePackageName=" + attributePackageName + ", attributeClassName=" + attributeClassName
			+ ", classInfoIdentifier1=" + classInfoIdentifier1 + ", classAttributeIdentifier1="
			+ classAttributeIdentifier1 + ", classMethodIdentifier1=" + classMethodIdentifier1
			+ ", classInfoIdentifier2=" + classInfoIdentifier2 + ", methodName=" + methodName
			+ ", classMethodIdentifier2=" + classMethodIdentifier2 + ", attributeDataTypeName=" + attributeDataTypeName
			+ "]";
   }
