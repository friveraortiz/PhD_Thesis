...
public class AOPFileController 
{
   ...
   public int save(ConfigFileFormEvent ev, String databaseConfigFile) throws Exception
   {
	  ...
	  String projectName="", jarFileName="", projInputDir="", projOutputDir="", progLanguage="",
	         ...
	         connectProjMethodReturnValue="", connectProjMethodType ="",
	         operatingSystem="", projOutputRemoteDir="",
	         errorMessage1="";
	  int id1 = 0, id2=0;
	  ...
	  connectProjMethodType = ev.getConnectProjectMethodType();
	  operatingSystem    = ev.getOperatingSystem();
	  projOutputRemoteDir    = ev.getProjOutputRemoteDir();
   ...
   /*This function now receives two methods as an input
    Method Name: org.isf.menu.gui.Login.acceptPwd
                 ...
                 We need to separate them in order to validate each method
    * */
   public boolean validateMethod(String methodName) throws Exception
   {
      ...
      System.out.println("*** ENTRE A VALIDATE METHOD ***");
   ...
   public boolean connectMethodReturnValue(String methodValue)
   {
      boolean flag=false;
   ...
   public boolean connectMethodProjectType(String methodProjectType)
   {
      boolean flag=false;
  
      if(methodProjectType != null && !methodProjectType.trim().isEmpty())
         flag = true;
      else
         flag = false;
