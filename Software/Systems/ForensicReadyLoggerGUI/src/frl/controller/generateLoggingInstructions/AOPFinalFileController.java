...
public class AOPFinalFileController 
{
  ...
  public void updateTextFileProperties(String databaseConfigFile, int projectId, int headerId, String propertyName, String propertyValue) throws Exception
  {
     String errorMessage1 ="";
	 ...
	 try 
	 {
	    aopFinalFileDb.updateTextFileProperties(projectId, headerId, propertyName, propertyValue); 
	 }
	 catch (Exception e2) 
	 {
	    errorMessage1 = e2.getMessage();	
  ...
  public void updateProjectLoggingDetails(String databaseConfigFile, AOPFinalFileFormEvent aOPFinalFileFormEvent) throws Exception
  {  
     String errorMessage1 ="";
	 ...
	 try 
	 {
	    aopFinalFileDb.updateProjectLoggingDetails(aOPFinalFileFormEvent);
	 }
	 catch (Exception e2) 
	 {
	    errorMessage1 = e2.getMessage();	
