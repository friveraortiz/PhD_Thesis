...
public class AnnotateUMLSequenceDiagram 
{
			    ...
			    {	
                   ...
                   */
				   ...
				   {	     
				      ...
				      // Validate if the Attribute Data Type is an Enum
				      if(attributeDataTypeNameGUI.equals(frlCon.classDataType) == true)
				      {	  
				    	 if(parameterName.equals(attributeNameGUI) == false)
				    	 {	 
				            annotationElement1 = parameterDataType + frlCon.objectOrientedDelimiter1 + parameterName + frlCon.objectOrientedDelimiter1 + attributeNameGUI;
				            //System.out.println("CASE 1-A-a)");
				    	 }
				    	 else
				    	 {
					        annotationElement1 = parameterDataType + frlCon.objectOrientedDelimiter1 + parameterName;
				   ...
				   // Build the Annotation Element 2
	   ...
	   public void addOneAnnotationUMLSeqDiagram(String databaseConfigFile, 
			                                     FRLConfiguration frlCon, 
			                                     AnnotateUMLSequenceDiagramController annotateUMLSequenceDiagramController,
			                                     AnnotateUMLSequenceDiagramFormEvent ev) throws Exception
	   {
		  ...
		  String errorMessage1="", errorMessage2="", lineTextSD1="", lineType2SD1="", datumCategory2SD1="", datumValueSD1="",
		    	 ...
		    	 lineTextNewAnnotation="", annotationTypeGUI="", methodLineTextMD1="", value1="", value2="";
   ...
   // ==>>>> NEW METHOD
   public void addManyAnnotationsUMLSeqDiagram(String databaseConfigFile, 
		                                       FRLConfiguration frlCon, 
		                                       AnnotateUMLSequenceDiagramController annotateUMLSequenceDiagramController,
		                                       AnnotateUMLSequenceDiagramFormEvent ev) throws Exception
   {
      int c=0, m=0, diagramLineNumberSD1=0, methodLineNumberSD1=0, 
	      projectIdGUI=0, userIdGUI=0, methodIdGUI=0, methodStepIdGUI=0, parameterIdGUI=0, 
	      parameterDataTypeIdGUI=0, attributeIdGUI=0, valueIdGUI=0, returnTypeIdGUI=0,
	      returnTypeValueIdGUI=0, cmIdSD1=0, 
	      diagramLineNumberSD2=0, methodLineNumberSD2=0,
	  ...
	  System.out.println("ADD MANY ANNOTATIONS => PROCESS LEVEL");
	  ...
	  // Annotation Type Information (Method)
	  annotationTypeGUI  = ev.getAnnotationType();
	  
	  /************************************************/
	  // 2.- Loading Information from the Database
	  /************************************************/
	  ...
	  // Method Information
	  // Load all the methods from this User
	  try
	  {
	     methodDataList = annotateUMLSequenceDiagramController.loadMethodsSteps(projectIdGUI, userIdGUI);
	  }
	  catch (Exception e2) 
	  {
	     errorMessage1 = e2.getMessage();
		 errorMessage2 = "Error XXXX: Occurred while loading the Method Steps for this User: " + userIdGUI + System.lineSeparator();;
		 errorMessage2 = errorMessage2 + errorMessage1;
		 throw new Exception(errorMessage2);
	  }  
	  		

	  //System.out.println("*** 1.- Loading Information from the GUI fields ***");
	  
	  /************************************************/
	  // 3.- Loading all the Methods from this User
	  /************************************************/
	  
	  // Make a Loop through the Methods from this User
	  for (m = 0; m < methodDataList.size(); m++) 
	  {
	     methodIdGUI     = methodDataList.get(m).getMethodIdentifier();
         methodStepIdGUI = methodDataList.get(m).getMethodStepIdentifier();
	     methodNameGUI   = methodDataList.get(m).getMethodName();
	     methodTextFileNameGUI  = methodDataList.get(m).getMethodTextFileName();
	     methodImageFileNameGUI = methodDataList.get(m).getMethodImageFileName();

			   
	     System.out.println("*** 1.- LOADING INFORMATION FROM THE Method: "+ m + " method Step Name: "+methodStepIdGUI);
		 ...
		 /*********************************************************/
		 // 4.- Loading the UML Sequence Diagram from this Method
		 /********************************************************/
	     
		 // Get the initial UML Sequence Diagram from the Method Level
		 try 
		 {
		     //umlSeqDiagram1List = annotateUMLSequenceDiagramController.loadUMLSequenceDiagramUser(projectIdGUI, userIdGUI);
		    umlSeqDiagram1List = annotateUMLSequenceDiagramController.loadUMLSequenceDiagramMethod(projectIdGUI, userIdGUI, 
	                                                                                               methodIdGUI, methodStepIdGUI);
		 }
		 catch (Exception e3) 
		 ...
		 /*********************************************************/
		 // 5.- Loading the UML Sequence Diagram from this Method
		 /********************************************************/
	     ...
	     System.out.println("*** 2.- LOADING INFORMATION FROM THE UML SEQUENCE DIAGRAM OF THE Method: "+c + " method Step Name: "+methodStepIdGUI);
	     System.out.println("Diagram Line Number SD1     : " + diagramLineNumberSD1);
	     System.out.println("Method Line Number SD1      : " + methodLineNumberSD1);
	     System.out.println("Line Text SD1               : " + lineTextSD1);
	     System.out.println("Line Type 1 SD1             : " + lineType1SD1);
	     ...
	     System.out.println("Class Method Identifier SD1 : " + cmIdSD1);
		    ...
		    System.out.println("Diagram Line Number MD1     : " + diagramLineNumberMD1);
		    System.out.println("Method Line Number  MD1     : " + methodLineNumberMD1);
		    System.out.println("Class Method       MD1      : " + cmIdMD1);
		    System.out.println("Method Line Number  MD1    : " + methodLineTextMD1);
	     	...
	     	if(lineType1SD1.equals(LineType1.MethodEnds))
	     	{
			    ...
			    System.out.println("Diagram Line Number ME1     : " + diagramLineNumberME1);
			    System.out.println("Method Line Number  ME1     : " + methodLineNumberME1);
			    System.out.println("Class Method       ME1      : " + cmIdME1);
			    System.out.println("Method Line Number  SD1     : " + methodLineNumberSD2);
	     	}
		    ...
		    System.out.println("Diagram Line Number NS1     : " + diagramLineNumberNS1);
		    System.out.println("Method Line Number  NS1     : " + methodLineNumberNS1);
		    System.out.println("Class Method       S1       : " + cmIdNS1);
		    System.out.println("Diagram Line Number NE1     : " + diagramLineNumberNE1);
		    System.out.println("Method Line Number  NE1     : " + methodLineNumberNE1);
		    System.out.println("Class Method       NE1      : " + cmIdNE1);
		 ...
		 /****************************************************************************/
		 // 6.- Create the Annotation into the UML Sequence Diagram 
		 /****************************************************************************/
	     // Build the annotation into the UML Sequence Diagram
		 try 
		 {
	  ...
	  System.out.println("*** ==> VICTORY: FINISHED TO ADD ALL THE ANNOTATION! ***");
   }	   
   ...
   public void changeUserName(String userName1, String userName2, String outputDirectory, String umlSequenceDiagramTextFile) throws Exception
   {
	  ...
	  */
	  ...
	  BufferedWriter writer = new BufferedWriter(new FileWriter(outputFile))) 
	  {
	     ...
	     {
	        // Replace occurrences of userName1 with userName2
	        line = line.replace(userName1, userName2);
	        writer.write(line);
	        writer.newLine();
	     }
	  } 
	  ...
	  {
	     errorMessage1 = e1.getMessage();
	     errorMessage2 = "Error XXXX: Occurred while changing the User Name 1: "+userName1 + System.lineSeparator();
	     errorMessage2 = errorMessage2 + "to User Name 2: "+userName2 + System.lineSeparator();
	     errorMessage2 = errorMessage2 + "in the File: "+umlSequenceDiagramTextFile + System.lineSeparator();
		 errorMessage2 = errorMessage2 + errorMessage1;
		 throw new Exception(errorMessage2);
	  }
   ...
   public void mergeFiles(String umlSeqDiagramText1, String umlSeqDiagramText2, String outputDirectory) throws Exception
   {
	  ...
	  {
	     errorMessage1="Error XXXX: One or both UML Sequence Diagram Text Files do not exist.";
	     throw new Exception(errorMessage1);
	  }
	     
	  outputFile = new File(outputDirectory, "IncidentSequenceDiagram.txt");
	     ...
	     BufferedWriter writer = new BufferedWriter(new FileWriter(outputFile))) 
	  {
	     ...
	     // Write content of file1 to the output file
	     while ((line = reader1.readLine()) != null) 
	     {
	    	if(line.startsWith("@enduml") == false)
	    	{	
	           writer.write(line);
	           writer.newLine();
	    	}
	     ...
	     // Write content of file2 to the output file
	     while ((line = reader2.readLine()) != null) 
	     {
	    	if(line.startsWith("@startuml") == false) 
	    	   if(line.startsWith("skinparam") == false)
	    	      if(line.startsWith("ArrowColor") == false)
	    	         if(line.startsWith("ActorBorderColor") == false)
	    	    	    if(line.startsWith("LifeLineBorderColor") == false)
	    	    		   if(line.startsWith("LifeLineBackgroundColor") == false)
	    	    		      if(line.startsWith("ParticipantBorderColor") == false)
	    	    		         if(line.startsWith("ParticipantBackgroundColor") == false)
	    	    		    	    if(line.startsWith("ParticipantFontName") == false)
	    	    		    		   if(line.startsWith("ParticipantFontSize") == false)
	    	    		    		      if(line.startsWith("ParticipantFontColor") == false)
	    	    		    			     if(line.startsWith("ActorBackgroundColor") == false)
	    	    		    				    if(line.startsWith("ActorFontColor") == false)
	    	    		    					   if(line.startsWith("ActorFontSize") == false)
	    	    		    					      if(line.startsWith("ActorFontName") == false)
	  ...
	  {
	     errorMessage1 = e1.getMessage();
		 errorMessage2 = "Error XXXX: Occurred while combining the UML Sequence Diagram 1: "+umlSeqDiagramText1 + System.lineSeparator();
		 errorMessage2 = errorMessage2 + "and User Sequence Diagram 2: "+umlSeqDiagramText1 + System.lineSeparator();
	     errorMessage2 = errorMessage2 + errorMessage1;
	     throw new Exception(errorMessage2);
	  }
