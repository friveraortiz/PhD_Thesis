...
public class UMLSequenceDiagramFrame extends JFrame 
{
        ...
        umlSequenceDiagramFormPanel.setUserFormListener(new UMLSequenceDiagramFormListener() 
        {
			...
			public boolean openUmlSeqDiagramImageEventOccurred_0(UMLSequenceDiagramFormEvent e) 
			{
			   ...
			   {	
			      ...
			      umlSequenceDiagramFormPanel.umlSeqDiagramImageField0.setText(umlSequenceDiagramImage);
			   }			
			...
			public boolean openUmlSeqDiagramTextEventOccurred_0(UMLSequenceDiagramFormEvent e) 
			{
			   ...
			   {	
				  ...
				  umlSequenceDiagramFormPanel.umlSeqDiagramTextField0.setText(umlSequenceDiagramText);
			   }			
	 	    ...
	 	    @Override
		    public boolean generateEventOccurred(UMLSequenceDiagramFormEvent ev) 
	 	    {
	 	       ...
	 	       umlImageFileName = ev.getUmlSeqDiagramImage1();
	 	       umlTextFileName  = ev.getUmlSeqDiagramText1();
			...
			@Override
			public boolean changeEventOccurred(UMLSequenceDiagramFormEvent ev) 
			{
			   String projOutputDir="", userName1="", userName2="", umlSeqDiagramText="", errorMessage1="";

			   projOutputDir = ev.getProjOutputDir();
			   userName1 = ev.getUserName1();
			   userName2 = ev.getUserName2();  
			   umlSeqDiagramText = ev.getUmlSeqDiagramText1();
				   
			   if(userName1 == null || userName1.isEmpty() == true)
	     	   {
                  errorMessage1 = "Error XXXX: The UserName 1: " + System.lineSeparator() + userName1 + System.lineSeparator()+ " is EMPTY and should have a VALUE." ; 
	     		  
     		      // Error #2 
                  printErrorMessage(errorMessage1, "Validating the User Name 1");
                  return false;
	     	   }  
			   else if(userName2 == null || userName2.isEmpty() == true)
	     	   {
	              errorMessage1 = "Error XXXX: The UserName 2: " + System.lineSeparator() + userName2 + System.lineSeparator()+ " is EMPTY and should have a VALUE." ; 
		     		  
	     		  // Error #2 
	              printErrorMessage(errorMessage1, "Validating the User Name 2");
	              return false;
		       } 
			   else if(umlSeqDiagramText == null || umlSeqDiagramText.isEmpty() == true)
	     	   {
	              errorMessage1 = "Error XXXX: The UML Diagram Text File : " + System.lineSeparator() + umlSeqDiagramText + System.lineSeparator()+ " is EMPTY and should have a VALUE." ; 
		     		  
	     		  // Error #2 
	              printErrorMessage(errorMessage1, "Validating the UML Diagram Text File ");
	              return false;
		       } 
			   else if(projOutputDir == null || projOutputDir.isEmpty() == true)
	     	   {
	              errorMessage1 = "Error XXXX: The Project Output Directory : " + System.lineSeparator() + projOutputDir + System.lineSeparator()+ " is EMPTY and should have a VALUE." ; 
		     		  
	     		  // Error #2 
	              printErrorMessage(errorMessage1, "Validating the Project Output Directory ");
	              return false;
		       } 
			   else
			   {   
			      changeUserName(userName1, userName2, projOutputDir, umlSeqDiagramText);
			...
			@Override
			public boolean mergeEventOccurred(UMLSequenceDiagramFormEvent ev) 
			{
		       String projOutputDir="", umlSeqDiagramText1="", umlSeqDiagramText2="", errorMessage1="";

			   projOutputDir = ev.getProjOutputDir();
			   umlSeqDiagramText1 = ev.getUmlSeqDiagramText1();
			   ...
			   */
		       ...
		       {
		          errorMessage1 = "Error XXXX: The UML Diagram Text File 1: " + System.lineSeparator() + umlSeqDiagramText1 + System.lineSeparator()+ " is EMPTY and should have a VALUE." ; 
			     		  
		     	  // Error #2 
		          printErrorMessage(errorMessage1, "Validating the UML Diagram Text File ");
		          return false;
			   } 
			   else if(umlSeqDiagramText2 == null || umlSeqDiagramText2.isEmpty() == true)
		       {
			      errorMessage1 = "Error XXXX: The UML Diagram Text File 2: " + System.lineSeparator() + umlSeqDiagramText2 + System.lineSeparator()+ " is EMPTY and should have a VALUE." ; 
			   ...
			   {   
			      mergeFiles(umlSeqDiagramText1, umlSeqDiagramText2, projOutputDir);
			...
			public boolean openUmlSeqDiagramTextEventOccurred_1(UMLSequenceDiagramFormEvent e) 
			{
			   ...
			   {	
			      umlSequenceDiagramText = fileChooser.getSelectedFile().getAbsolutePath();
				  umlSequenceDiagramFormPanel.umlSeqDiagramTextField1.setText(umlSequenceDiagramText);
			   }			
			...
			public boolean openUmlSeqDiagramTextEventOccurred_2(UMLSequenceDiagramFormEvent e) 
			{
			   ...
			   {	
			      umlSequenceDiagramText = fileChooser.getSelectedFile().getAbsolutePath();
				  umlSequenceDiagramFormPanel.umlSeqDiagramTextField2.setText(umlSequenceDiagramText);
			   }			
			...
			public boolean openUmlSeqDiagramTextEventOccurred_3(UMLSequenceDiagramFormEvent e) 
			{
			   ...
			   {	
			      umlSequenceDiagramText = fileChooser.getSelectedFile().getAbsolutePath();
				  umlSequenceDiagramFormPanel.umlSeqDiagramTextField3.setText(umlSequenceDiagramText);
			   }			
		     ...
		     FRLConfiguration frlCon)
   {
      ...
      umlSeqDiagTextFile = ev.getUmlSeqDiagramText1();
   ...
   void changeUserName(String userName1, String userName2, String outputDirectory, String umlSequenceDiagramTextFile)
   {
	  String errorMessage1=""; 
	  AnnotateUMLSequenceDiagram annotateUMLSequenceDiagram = new AnnotateUMLSequenceDiagram();
	  	  
	  try 
	  {
	     annotateUMLSequenceDiagram.changeUserName(userName1, userName2, outputDirectory, umlSequenceDiagramTextFile);
	  } 
	  catch (Exception e1) 
	  {
	     errorMessage1 = e1.getMessage();
	     printErrorMessage(errorMessage1, "Changing the UserName in the UML Sequence Diagram Text File");
      }
   }
   
   
   void mergeFiles(String umlSeqDiagramText1, String umlSeqDiagramText2, String outputDirectory)
   {
      String errorMessage1=""; 
	  AnnotateUMLSequenceDiagram annotateUMLSequenceDiagram = new AnnotateUMLSequenceDiagram();
      ...
      try 
      {
         annotateUMLSequenceDiagram.mergeFiles(umlSeqDiagramText1, umlSeqDiagramText2, outputDirectory);
      } 
      catch (Exception e1) 
      {
         errorMessage1 = e1.getMessage();
         printErrorMessage(errorMessage1, "Combining the UML Sequence Diagram Text Files");
      }
   }
