			                                ...
			                                int projectId, FRLConfiguration frlCon) 
	{
        ...
        annotateUMLSequenceDiagramFormPanel.setAnnotateUMLSequenceDiagramFormListener(new AnnotateUMLSequenceDiagramFormListener() 
        {
			...
			public boolean addOneAnnotationEventOccurred(AnnotateUMLSequenceDiagramFormEvent ev) 
			{
			   ...
			   addOneAnnotatonUMLSeqDiagram(databaseConfigFile, frlCon, ev, annotateUMLSequenceDiagramController);
			...
			{
			   addManyAnnotatonsUMLSeqDiagram(databaseConfigFile, frlCon, ev, annotateUMLSequenceDiagramController);
			   return true;
			}
...
*/      
                             ...
                             int parameterId, int parameterDataTypeId)
   {
	  String errorMessage="", attributeName="", attributeIdStr="",
			 attributeDataTypeName="", element="", attributeValue="";
	  ...
	  try 
	  {
		 ...
		 for (i = 0; i < attributeList.size(); i++) 
		 {
		    ...
		    /*
		    System.out.println("REFRESHING THE VALUES OF THE ATTRIBUTE NAME-FRAME");
  ...
  public void loadReturnTypeValues(String databaseConfigFile, int projectId, int methodId, int returnTypeId) 
  {
   ...
   public void addOneAnnotatonUMLSeqDiagram(String databaseConfigFile, 
   ...
   
   {
      ...
      try
      {
         annotateUMLSeqDiagram.addOneAnnotationUMLSeqDiagram(databaseConfigFile, 
    			                                             frlCon, 
                                                             annotateUMLSequenceDiagramController,
                                                             ev);
      }
  	  ...
  	  {
         errorMessage1 = e1.getMessage();
  	     printErrorMessage(errorMessage1, "Calling the complete Add One Annotation Process");
      }
   ...
   public void addManyAnnotatonsUMLSeqDiagram(String databaseConfigFile, FRLConfiguration frlCon, 
                                              AnnotateUMLSequenceDiagramFormEvent ev, 
                                              AnnotateUMLSequenceDiagramController annotateUMLSequenceDiagramController)
   {
      String errorMessage1="", errorMessage2="", userTextFileName="", userImageFileName="", userNameGUI="", 
	  ...
	  System.out.println("ADD MANY ANNOTATIONS => FRAME LEVEL");
	  
	  // Add many annotations into the UML Sequence Diagram
	  try
	  {
	     annotateUMLSeqDiagram.addManyAnnotationsUMLSeqDiagram(databaseConfigFile, 
		    			                                       frlCon, 
		                                                       annotateUMLSequenceDiagramController,
		                                                       ev);
	   }
	   ...
	   {
	      errorMessage1 = e1.getMessage();
		  printErrorMessage(errorMessage1, "Calling the complete Add Many Annotations Process");
	   }
