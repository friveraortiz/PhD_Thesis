...
public class ConfigFileFormEvent extends EventObject 
{
   ...
   private String connectProjectMethodType;
   private String projOutputRemoteDir;
   ...
   public ConfigFileFormEvent(Object source, int id, String featuresConfigFile, String databaseConfigFile,
		                      ...
		                      String connectProjectMethodType, 
		                      String operatingSystem, String projOutputRemoteDir, String newLine1,
                              ...
                              String nonPrimitiveValue4,String startClassDef, String endClassDef) 
   {
        ...
        this.connectProjectMethodType = connectProjectMethodType;
        this.projOutputRemoteDir      = projOutputRemoteDir;
   ...
   public ConfigFileFormEvent(Object source, String featuresConfigFile, String databaseConfigFile, String projectName,
                              ...
                              String connectProjectMethodType, 
                              String operatingSystem, String projOutputRemoteDir, 
                              String newLine1,
                              String newLine2, String objectOrientedDelimiter1, String startMethod,
                              String endMethod, String startParameters, String endParameters,
                              String singleLineComment, String endStatementDelimiter, 
...
public String getProjectName() 
   ...
   public String getConnectProjectMethodType() 
   {
      return connectProjectMethodType;
   }

   public void setConnectProjectMethodType(String connectProjectType) 
   {
      this.connectProjectMethodType = connectProjectType;
   }

   public String getProjOutputRemoteDir() 
   {
      return projOutputRemoteDir;
   }

   public void setProjOutputRemoteDir(String projOutputRemoteDir) 
   {
      this.projOutputRemoteDir = projOutputRemoteDir;
   }
   ...
   public String toString() 
   {
      return "ConfigFileFormEvent [id=" + id + ", featuresConfigFile=" + featuresConfigFile + ", databaseConfigFile="
			...
			+ connectProjectMethodReturnValue + ", connectProjectMethodType=" + connectProjectMethodType
			+ ", log4jConfPath=" + projOutputRemoteDir + ", operatingSystem=" + operatingSystem + ", newLine1=" + newLine1
