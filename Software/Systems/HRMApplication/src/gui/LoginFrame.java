...
private LoginFormPanel loginFormPanel;
	...
	public LoginFrame () 
	{
        ...
        //System.out.println("STARTING the LoginFrame method");
        ...
        loginFormPanel.setLoginFormPanelListener(new LoginFormPanelListener() 
        {
		   ...
		   public void loginFormEventOccurred(UserFormEvent e) 
		   {
			  ...
			  //System.out.println("STARTING the loginFormEventOccurred method");
         	 ...
         	 //System.out.println("ENDING the loginFormEventOccurred method");
		...
		//System.out.println("ENDING of LoginFrame method");
    }
	...
	public boolean validateUser(UserFormEvent e)
	{
	   ...
	   //System.out.println("STARTING the validateUser method");
 	   ...
 	   //System.out.println("ENDING the validateUser method");
	...
	public UserLevel getUserLevel(UserFormEvent e)
	{
	   ...
	   //System.out.println("STARTING the getUserLevel method");
 	   ...
 	   //userController.example(1, "Uno");
 	   
 	   //System.out.println("User Level: " + userLevel);
 	   //System.out.println("ENDING the getUserLevel method");
