...
public class AOPFinalFileFrame extends JFrame 
{
			                  ...
			                  String databaseConfigFile, String featuresConfigFile) 
	{
        ...
        aopFinalFileFormPanel.setUserFormListener(new AOPFinalFileFormListener() 
        {
			...
			@Override
			public boolean openLibDirectoryEventOccurred(AOPFinalFileFormEvent ev) 
			{
			   String libDirectory="";
			   int returnVal;
			   ...
			   if(returnVal == JFileChooser.APPROVE_OPTION)
			   {	
				  libDirectory = fileChooser.getSelectedFile().getAbsolutePath();
			      aopFinalFileFormPanel.libDirectoryField.setText(libDirectory);
			   }			
			...
			@Override
			public boolean openOutputRemoteDirectoryEventOccurred(AOPFinalFileFormEvent ev) 
			{
		       String outputRemoteDir="";
			   int returnVal;
			   ...
			   if(returnVal == JFileChooser.APPROVE_OPTION)
			   {	
				  outputRemoteDir = fileChooser.getSelectedFile().getAbsolutePath();
				  aopFinalFileFormPanel.projOutputRemoteDirField.setText(outputRemoteDir);
			   }			
	...
	public void refreshProject(String databaseConfigFile)
	{
	   ...
	   aopFinalFileFormPanel.endProjMethodArea.setText(stringSel);	
	   
	   // Connect Project Method
	   stringSel = projectTablePanel.getProjectStringColSel(10);
	   aopFinalFileFormPanel.connectProjMethodArea.setText(stringSel);	
	   
	   // Connect Project Method Value
	   stringSel = projectTablePanel.getProjectStringColSel(11);
	   aopFinalFileFormPanel.connectProjMethodReturnValueArea.setText(stringSel);	
	   
	   // Connect Project Method Type
	   stringSel = projectTablePanel.getProjectStringColSel(12);
	   aopFinalFileFormPanel.connectProjMethodTypeArea.setText(stringSel);
	   
	   // Remote Operating System Method
	   stringSel = projectTablePanel.getProjectStringColSel(13);
	   aopFinalFileFormPanel.remoteOperatingSystemField.setText(stringSel);	
	   
	   // Remote Project Output Directory
	   stringSel = projectTablePanel.getProjectStringColSel(14);
	   aopFinalFileFormPanel.projOutputRemoteDirField.setText(stringSel);	
	   
	   // Log Directory
	   stringSel = projectTablePanel.getProjectStringColSel(15);
	   aopFinalFileFormPanel.logDirectoryField.setText(stringSel);
	   
	   // Lib Directory
	   stringSel = projectTablePanel.getProjectStringColSel(16);
	   aopFinalFileFormPanel.libDirectoryField.setText(stringSel);

	   aopFinalFileFormPanel.remoteOperatingSystemField.requestFocusInWindow();
