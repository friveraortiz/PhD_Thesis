...
public class AOPFinalFileFormEvent extends EventObject 
{
   ...
   public AOPFinalFileFormEvent(Object source, int projectId, String projectName, String projectInputDir, String projectOutputDir, int programmingLanguageId,
                                ...
                                String dataTypeStringList, String dataTypeNumberList, String logDirectory, String libDirectory, String annotationFile, String annotationFilePrefix,
                                ...
                                String findString, String textFileNameExt3, String remoteOS, String remoteOutputDir)
   {
      super(source);
      this.projectId                = projectId;
      this.projectName              = projectName;
  ...
  public void setGuiLibDelimiter(String guiLibDelimiter) 
  {
   ...
   public String toString() {
	   return "AOPFinalFileFormEvent [projectId=" + projectId + ", featuresConfigFile=" + featuresConfigFile
			+ ", databaseConfigFile=" + databaseConfigFile + ", projectName=" + projectName + ", jarFileName="
			+ jarFileName + ", projectInputDir=" + projectInputDir + ", projectOutputDir=" + projectOutputDir
			+ ", dbms=" + dbms + ", inputMethod=" + inputMethod + ", startProjectMethod=" + startProjectMethod
			+ ", endProjectMethod=" + endProjectMethod + ", connectProjectMethod=" + connectProjectMethod
			+ ", operatingSystem=" + operatingSystem + ", newLine1=" + newLine1 + ", newLine2=" + newLine2
			+ ", objectOrientedDelimiter1=" + objectOrientedDelimiter1 + ", startMethod=" + startMethod + ", endMethod="
			+ endMethod + ", startParameters=" + startParameters + ", endParameters=" + endParameters
			+ ", singleLineComment=" + singleLineComment + ", endStatementDelimiter=" + endStatementDelimiter
			+ ", startClassList=" + startClassList + ", endClassList=" + endClassList + ", bluePrintObject1="
			+ bluePrintObject1 + ", bluePrintObject2=" + bluePrintObject2 + ", initializeObjectName="
			+ initializeObjectName + ", initializeObjectMethod=" + initializeObjectMethod + ", subProgramObject="
			+ subProgramObject + ", methodNameException=" + methodNameException + ", printMessage=" + printMessage
			+ ", startLineNum=" + startLineNum + ", startArray=" + startArray + ", endArray=" + endArray
			+ ", umlSeqDiagramImage=" + umlSeqDiagramImage + ", umlSeqDiagramText=" + umlSeqDiagramText + ", userId="
			+ userId + ", userName=" + userName + ", methodId=" + methodId + ", methodName=" + methodName
			+ ", programmingLanguageId=" + programmingLanguageId + ", programmingLanguageName="
			+ programmingLanguageName + ", parameterId=" + parameterId + ", parameterDataTypeId=" + parameterDataTypeId
			+ ", parameterFullName=" + parameterFullName + ", attributeId=" + attributeId + ", attributeName="
			+ attributeName + ", logDirectory=" + logDirectory + ", libDirectory=" + libDirectory + ", annotationFile="
			+ annotationFile + ", annotationFilePrefix=" + annotationFilePrefix + ", findWhiteSpaces=" + findWhiteSpaces
			+ ", validSpecialCharacter=" + validSpecialCharacter + ", valueDelimiter=" + valueDelimiter
			+ ", dataTypeFullClassName=" + dataTypeFullClassName + ", dataTypeShortClassName=" + dataTypeShortClassName
			+ ", dataTypeStringList=" + dataTypeStringList + ", dataTypeNumberList=" + dataTypeNumberList
			+ ", confPropertyName1=" + confPropertyName1 + ", startCallMethod=" + startCallMethod + ", endCallMethod1="
			+ endCallMethod1 + ", callMethodDelimiter=" + callMethodDelimiter + ", assignValueDelimiter="
			+ assignValueDelimiter + ", guiLibDelimiter=" + guiLibDelimiter + ", findString=" + findString
			+ ", textFileNameExt3=" + textFileNameExt3 + ", remoteOS=" + remoteOS + ", remoteOutputDir="
			+ remoteOutputDir + "]";
   }  
