...
public class AnnotateUMLSequenceDiagramFormEvent extends EventObject 
{
   ...
   // Constructor #12
   public AnnotateUMLSequenceDiagramFormEvent(Object source, int projectId, int userId, String userName,           
                                              String userTextFileName, String userImageFileName, String whQuestionName, 
                                              int methodId, int methodStepId, String methodName,       
                                              String methodTextFileName, String methodImageFileName, String annotationType)
   {
	      super(source);
		  this.projectId           = projectId;
		  this.userId              = userId;
