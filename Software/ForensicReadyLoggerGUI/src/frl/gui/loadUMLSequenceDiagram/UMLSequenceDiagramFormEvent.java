...
public class UMLSequenceDiagramFormEvent extends EventObject 
{
   ...
   private String umlSeqDiagramImage1;
   private String umlSeqDiagramText1;
   private String userName1;
   private String userName2;
   private String umlSeqDiagramText2;
   ...
   public UMLSequenceDiagramFormEvent(Object source, int projectId, String featuresConfigFile, String databaseConfigFile,
                                      ...
                                      String umlSeqDiagramImage1, String umlSeqDiagramText1) 
   {
		super(source);
        ...
        this.umlSeqDiagramImage1      = umlSeqDiagramImage1;
        this.umlSeqDiagramText1       = umlSeqDiagramText1;
   }
   ...
   public UMLSequenceDiagramFormEvent(Object source, int projectId, String featuresConfigFile, String databaseConfigFile,
                              ...
                              String aspectOrientedFile2, String umlSeqDiagramImage1, String umlSeqDiagramText1) 
   {
      super(source);
      this.projectId = projectId;
      this.featuresConfigFile   = featuresConfigFile;
   ...
   public UMLSequenceDiagramFormEvent(Object source, int projectId, String field, String value) 
   {
		...
		switch(field)
		{
		   ...
		   case "UMLSeqDiagramImage": 
			   this.umlSeqDiagramImage1 = value;
		   break;
		   
		   case "UMLSeqDiagramFile": 
			   this.umlSeqDiagramText1 = value;
		   break;
   ...
   // Constructor # 9
   public UMLSequenceDiagramFormEvent(Object source, int projectId, String featuresConfigFile, String databaseConfigFile,
		                              String projectName, String projectOutputDir, String userName1, String userName2,
		                              String umlSeqDiagramText1) 
   {
		super(source);
		this.projectId = projectId;
        this.featuresConfigFile   = featuresConfigFile;
   ...
   // Constructor # 10
   public UMLSequenceDiagramFormEvent(Object source, int projectId, String featuresConfigFile, String databaseConfigFile,
		                              String projectName, String projectOutputDir,
		                              String umlSeqDiagramText1, String umlSeqDiagramText2) 
   {
		super(source);
		this.projectId = projectId;
        this.featuresConfigFile   = featuresConfigFile;
        ...
        this.projectOutputDir     = projectOutputDir;
        this.umlSeqDiagramText1   = umlSeqDiagramText1;
        this.umlSeqDiagramText2   = umlSeqDiagramText2;
...
public String getProjectName() 
   ...
   public String getUmlSeqDiagramImage1() 
   {
	   return umlSeqDiagramImage1;
   }

   public String getUmlSeqDiagramText1() 
   {
	   return umlSeqDiagramText1;
   }

   public void setUmlSeqDiagramImage(String umlSeqDiagramImage) 
   {
      this.umlSeqDiagramImage1 = umlSeqDiagramImage;
   }

   public void setUmlSeqDiagramText1(String umlSeqDiagramText) 
   {
	   this.umlSeqDiagramText1 = umlSeqDiagramText;
   }
   ...
   public String getUmlSeqDiagramText2() 
   {
      return umlSeqDiagramText2;
   }

   public void setUmlSeqDiagramText2(String umlSeqDiagramText2) 
   {
      this.umlSeqDiagramText2 = umlSeqDiagramText2;
   }

   public void setUmlSeqDiagramImage1(String umlSeqDiagramImage1) 
   {
      this.umlSeqDiagramImage1 = umlSeqDiagramImage1;
   }
