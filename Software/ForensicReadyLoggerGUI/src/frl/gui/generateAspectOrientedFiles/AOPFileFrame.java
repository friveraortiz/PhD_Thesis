...
public class AOPFileFrame extends JFrame 
{
			             ...
			             String databaseConfigFile, String featuresConfigFile) 
	{
        ...
        configFileFormPanel.setUserFormListener(new ConfigFileFormListener() 
        {
		    ...
		    public boolean configFileFormSaveEventOccurred(ConfigFileFormEvent ev) 
	 	    {
	 	       boolean validProject=false, validJarFile1=false, validJarFile2=false, validDirs=false, 
	 	    		   ...
	 	    		   validEndMethod=false, validConnectMethodReturnValue=false, validConnectMethodProjectType=false;
	 	       String jarFileName="", inputDir="", outputDir="", projectName="", startMethod="", endMethod="",
	 	    		  connectMethod="", connectMethodReturnValue="", connectMethodProjectType="",
	 	    		  outputRemoteDir="", errorMessage="";
	 	       ...
	 	       endMethod     = configFileFormPanel.endProjMethodArea.getText();
	 	       
	 	       connectMethod            = configFileFormPanel.connectProjMethodArea.getText();
	 	       connectMethodReturnValue = configFileFormPanel.connectProjMethodReturnValueArea.getText();
	 	       
	 	       connectMethodProjectType = configFileFormPanel.connectProjMethodTypeArea.getText();
	 	       outputRemoteDir          = configFileFormPanel.projOutputRemoteDirField.getText();
	 	      ...
	 	      /*This function now receives two methods as an input
	 	      Method Name: org.isf.menu.gui.Login.acceptPwd
	 	                   org.isf.menu.manager.UserBrowsingManager.getMenu
	 	                   
	 	                   We need to separate  each method to validate them
	 	      * */
			   ...
			   */
	 	       ...
	 	       catch (Exception e6) 
	 	       {
	              ...
	              JOptionPane.showMessageDialog(AOPFileFrame.this, errorMessage, "Validating the Connect Method Return Value: " + connectMethodReturnValue, JOptionPane.ERROR_MESSAGE);
	              return false;
			   }
	 	       ...
	 	       try 
	 	       {
	 	    	  validConnectMethodProjectType = aopFileController.connectMethodProjectType(connectMethodProjectType);
			   } 
	 	       catch (Exception e7) 
	 	       {
	 	 	      errorMessage = e7.getMessage();
	              JOptionPane.showMessageDialog(AOPFileFrame.this, errorMessage, "Validating the Connect Method Parameter Type: " + connectMethodProjectType, JOptionPane.ERROR_MESSAGE);
	              return false;
			   }
	     	                	...
	     	                	if(validStartMethod == false)
	 	     	                {
	     	                	   ...
	     	                	   if(validConnectMethod == false)
	                               {
	     	                	      ...
	     	                	      if(validEndMethod == false)
		                              {
		                                 ...
		                                 {
	                                        // Error #8
	                                        JOptionPane.showMessageDialog(AOPFileFrame.this, "Error XXXX: The Connect Method Return Value: " + connectMethodReturnValue + System.lineSeparator() + " is EMPTY. It should contain a value." , "Validating the Connect Method Return Value", JOptionPane.ERROR_MESSAGE);
	                                        return false;
		                                 }
	   	     	                	     else 
	   	     	                	    	 if(validConnectMethodProjectType == false)
                                             {
                                                // Error #9
                                                JOptionPane.showMessageDialog(AOPFileFrame.this, "Error XXXX: The Connect Method Type: " + connectMethodProjectType + System.lineSeparator() + " is EMPTY. It should contain a value." , "Validating the Connect Method Type", JOptionPane.ERROR_MESSAGE);
                                                return false;
                                             }	 	       
	   	     	                	         else*/
	     	                                 {
			...
			@Override
			public boolean configFileFormOpenRemoteOutputDirEventOccurred(ConfigFileFormEvent e) 
			{
			   String openRemoteOutputDir;
			   int returnVal;
			   ...
			   if(returnVal == JFileChooser.APPROVE_OPTION)
			   {	
			      openRemoteOutputDir = fileChooser.getSelectedFile().getAbsolutePath(); 
				  configFileFormPanel.projOutputRemoteDirField.setText(openRemoteOutputDir);
			   }
			   return true;
			}
	...
	public void refreshProject()
	{
	   ...
	   configFileFormPanel.endProjMethodArea.setText(stringSel);	
	   
	   // Connect Project Method
	   stringSel = projectTablePanel.getProjectStringColSel(10);
	   configFileFormPanel.connectProjMethodArea.setText(stringSel);	
	   
	   // Connect Project Method Return Value
	   stringSel = projectTablePanel.getProjectStringColSel(11);
	   configFileFormPanel.connectProjMethodReturnValueArea.setText(stringSel);
	   
	   // Connect Project Method Type
	   stringSel = projectTablePanel.getProjectStringColSel(12);
	   configFileFormPanel.connectProjMethodTypeArea.setText(stringSel);
	   
	   // Operating System 
	   stringSel = projectTablePanel.getProjectStringColSel(13);
	   configFileFormPanel.remoteOperatingSystemField.setText(stringSel);	
	   
	   // Project Remote Output Directory
	   stringSel = projectTablePanel.getProjectStringColSel(14);
	   configFileFormPanel.projOutputRemoteDirField.setText(stringSel);
   ...
   {	  
	  ...
	  try 
	  {
	     aopFileController.loadProjects(databaseConfigFile);
		 projectTablePanel.refresh();
	  } 
	  catch (Exception e) 
	  {
	     ...
	     JOptionPane.showMessageDialog(AOPFileFrame.this, "Error 6541: Occurred while loading the Projects. Error Message: "+errorMessage, "Loading Users", JOptionPane.ERROR_MESSAGE);	
	  }
	  ...
	  {	  
		 ...
		 {	 
	        ...
	        if(errorMessage.isEmpty() == true)
			{
	           ...
	           //System.out.println("Error Messaage: "+errorMessage);
	           // If there is any error, print on the screen the error message
