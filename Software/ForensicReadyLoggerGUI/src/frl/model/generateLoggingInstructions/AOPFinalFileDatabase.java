...
public class AOPFinalFileDatabase 
{
   ...
   public void loadProjects() throws Exception 
   {
      ...
      String plName="", dbmsName="", inputMethodName="", startMethod="", endMethod="", connectMethod="", 
             connectMethodReturnValue="", connectMethodType="", operatingSystem="", remoteDir="", logDir="", libDir="";
      ...
      try
      {
	     ...
	     sql = sql + "pc.pc_connect_project_method_type connectMethodType, ";
	     sql = sql + "pc.pc_operating_system operatingSystem, ";	   
	     sql = sql + "pc.pc_project_output_remote_dir remoteDir, ";
	     sql = sql + "pc.pc_project_log_dir logDir, ";
	     sql = sql + "pc.pc_project_lib_dir libDir ";
	     ...
	     while(results.next()) 
	     {
	        ...
	        connectMethodType = results.getString("connectMethodType");
	        operatingSystem   = results.getString("operatingSystem");
	        remoteDir         = results.getString("remoteDir");
	        logDir            = results.getString("logDir");
	        libDir            = results.getString("libDir");
	        	        
	        // Change the delimiter: ";" for end of line character "\n"	        
	        connectMethod            = connectMethod.replace(";", System.lineSeparator());
	        connectMethodReturnValue = connectMethodReturnValue.replace(";", System.lineSeparator());
	        connectMethodType        = connectMethodType.replace(";", System.lineSeparator());
	        
	        endMethod = endMethod.replace(";", System.lineSeparator());
		    ...
		    ConfigFile configFile = new ConfigFile(id, projectName, jarFileName, inputDir, outputDir, 
                    ...
                    connectMethodType,
                    operatingSystem, remoteDir, logDir, libDir);
   ...
   public void updateTextFileProperties(int projectId, int headerId, String propertyName, String propertyValue) throws Exception
   {
      int col;
	  ...
	  {
	     errorMessage1 = e1.getMessage();
		 errorMessage2 = "Error XXXX: Occurred while updating the Text File Properties" + System.lineSeparator();
		 errorMessage2 = errorMessage2 + "Project Identifier: "+ projectId + System.lineSeparator();
		 errorMessage2 = errorMessage2 + "Header Identifier: " + headerId   + System.lineSeparator();
		 errorMessage2 = errorMessage2 + "Property Name: "     + propertyName   + System.lineSeparator();
		 errorMessage2 = errorMessage2 + "Property Value: "    + propertyValue  + System.lineSeparator();
		 errorMessage2 = errorMessage2 + "Error Message: " + errorMessage1;
		 throw new Exception(errorMessage2);
      }
   ...
   public void updateProjectLoggingDetails(AOPFinalFileFormEvent aOPFinalFileFormEvent) throws Exception
   {
      int id=0, col=0;
	      String updateSql="", errorMessage1="", errorMessage2="", 
	      remoteOS="", remoteOutputDir="", logDir="", libDir="";
	      PreparedStatement  updateStatement;
			
	   // Get the values from the GUI
	   id       = aOPFinalFileFormEvent.getProjectId();
	   remoteOS = aOPFinalFileFormEvent.getRemoteOS();
	   remoteOutputDir = aOPFinalFileFormEvent.getRemoteOutputDir();
	   logDir  = aOPFinalFileFormEvent.getLogDirectory();
	   libDir  = aOPFinalFileFormEvent.getLibDirectory();
	  
       // Updating a record in the project_configuration table
       try
       {
	      updateSql = "update project_configuration ";
	      updateSql = updateSql + "set pc_operating_system = ?, ";
	      updateSql = updateSql + "pc_project_output_remote_dir = ?, ";
	      updateSql = updateSql + "pc_project_log_dir = ?, ";
	      updateSql = updateSql + "pc_project_lib_dir = ? ";
		  ...
		  updateStatement.setString(col++, remoteOS);
		  updateStatement.setString(col++, remoteOutputDir);
		  updateStatement.setString(col++, logDir);
		  updateStatement.setString(col++, libDir);
	   ...
	   {
	      errorMessage1 = e1.getMessage();	
		  errorMessage2 = "Error XXXX: Occurred while updating the Logging Details of a Project." + System.lineSeparator();
		  errorMessage2 = errorMessage2 + "Error Message: " + errorMessage1;
		  throw new Exception(errorMessage2);
	   }	   
   }
